...
#include <Data/Hist_ITCH41_QBDF_Builder.h>
...
namespace hf_core {
  ...
  // ----------------------------------------------------------------
  int Hist_ITCH41_QBDF_Builder::process_raw_file(const string& file_name)
  {
    const char* where = "Hist_ITCH41_QBDF_Builder::process_raw_file";
