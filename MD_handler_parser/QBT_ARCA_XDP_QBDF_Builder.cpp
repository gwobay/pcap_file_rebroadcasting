...
#include <Data/QBT_ARCA_XDP_QBDF_Builder.h>
...
namespace hf_core {
  ...
  // ----------------------------------------------------------------
  int QBT_ARCA_XDP_QBDF_Builder::process_raw_file(const string& file_name)
  {
    const char* where = "QBT_ARCA_XDP_QBDF_Builder::process_raw_file";
    ...
    m_message_handler->init(m_source_name, ExchangeID::ARCX, m_params);
