...
#include <ExchangeSession/ASX_OUCH_Exchange_Session.h>
...
main(int argc, const char* argv[])
{
  ...
  decoder_options_t decoder_options[] = {
    ...
    { "asx_itch_sym_dir_data", ASX_ITCH_1_1_Handler::dump_sym_dir_data, "ASX ITCH Sym Dir" },
    ...
    { "asx_ouch", ASX_OUCH_Exchange_Session::dump, "XASX direct order entry" },
    ...
    { "asx_ouch_short", ASX_OUCH_Exchange_Session::dump_short, "XASX direct order entry" },
  ...
  if(0 == strcmp(decoder_name, "asx_itch_sym_dir_data")) {
    m->m_suppress_qrec = true;
    ASX_ITCH_1_1_Handler::dump_sym_dir_data_header(*m->m_ilogger);
  }
