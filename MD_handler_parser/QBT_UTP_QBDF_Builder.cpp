...
#include <Data/QBT_UTP_QBDF_Builder.h>
...
namespace hf_core {
  ...
  // ----------------------------------------------------------------
  int QBT_UTP_QBDF_Builder::process_raw_file(const string& file_name)
  {
    const char* where = "QBT_UTP_QBDF_Builder::process_raw_file";
    ...
    UTP_Handler::channel_info_map_t& cim = m_message_handler->m_channel_info_map;
    for (size_t i = 0; i < 32; ++i) {
      cim.push_back(UTP_Handler::channel_info_t("", i));
